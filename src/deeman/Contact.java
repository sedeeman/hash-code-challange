...
public class Contact {
    ...
    public Contact mergeContact(Contact contact) {
        // set values to newContact
        Contact newContact = new Contact(name);
        newContact.emails = new HashSet<>(this.emails);
        newContact.phones = new HashSet<>(this.phones);
        // merge input contact with newContact
    ...
    /**
     * If we consider only the name for equals and hashcode. we are loosing numbers and emails.
     * If  one person have multiple mobile numbers and emails,  that every object is getting the same hashcode
     * when we add the values with same hash value, hashmap will only keep different hash valued Objects.
     */
    @Override
